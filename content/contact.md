---
title: "Contact"
description: "Get in touch with Muhammad Ali Sajid - Software Engineer & Full Stack Developer"
...
.social-link {
  ...
  width: 48px;
  height: 48px;
  border: 1px solid var(--code-block-border, var(--border)) !important;
  border-bottom: 1px solid var(--code-block-border, var(--border)) !important;
  border-radius: var(--radius);
  color: var(--muted-foreground);
